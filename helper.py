    ...
    if uploaded_file is not None:
        ...
        if st.sidebar.button('Show Analysis'):
            ...
            with col1:
                ...
                days_count_df = days_count_df.rename(columns={'day_name':'Day','count':'count'})
                                              
                # PLOTLY EXPRESS BAR PLOT
                fig = px.bar(data_frame=days_count_df,x=days_count_df['Day'],y=days_count_df['count'])
            ...
            with col2:
                ...
                months_count_df = months_count_df.rename(columns={'month':'Month','count':'count'})
            ...
            if selected_user=='Overall':
                ...
                with col1:
                    # BARPLOT
                    # st.dataframe(x)
                    fig = px.bar(data_frame=x,x=x['user'],y=x['count'])
                ...
                with col2:
                    new_df = new_df.rename(columns={'user':'user','count':'percent'})
